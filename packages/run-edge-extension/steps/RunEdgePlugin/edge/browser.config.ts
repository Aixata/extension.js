...
export default function browserConfig(
  ...
  // Ref: https://github.com/cezaraugusto/chromium-edge-launcher/blob/main/docs/edge-flags-for-tools.md
  return [
    ...
    // Specifies which in-product help (IPH) features are allowed. If no arguments are provided,
    // then all IPH features are disabled.
